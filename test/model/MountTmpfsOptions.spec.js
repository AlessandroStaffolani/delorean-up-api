...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeloreanUpApi.MountTmpfsOptions();
  });
  ...
  describe('MountTmpfsOptions', function() {
    it('should create an instance of MountTmpfsOptions', function() {
      // uncomment below and update the code to test MountTmpfsOptions
      //var instance = new DeloreanUpApi.MountTmpfsOptions();
      //expect(instance).to.be.a(DeloreanUpApi.MountTmpfsOptions);
    });
