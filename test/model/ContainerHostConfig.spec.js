...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeloreanUpApi.ContainerHostConfig();
  });
  ...
  describe('ContainerHostConfig', function() {
    it('should create an instance of ContainerHostConfig', function() {
      ...
      //var instance = new DeloreanUpApi.ContainerHostConfig();
      //expect(instance).to.be.a(DeloreanUpApi.ContainerHostConfig);
    });
